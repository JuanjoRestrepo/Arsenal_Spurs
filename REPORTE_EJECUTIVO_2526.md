...
> [!IMPORTANT]
> El doblete es el evento más difícil de cuantificar en el fútbol moderno. Una probabilidad del **40.45%** representa el escenario realista actual dadas las posiciones de la tabla al final de la temporada.
